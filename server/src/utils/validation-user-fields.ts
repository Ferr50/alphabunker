import {User, Error, LoginUser} from '../models';

class ValidationUserFields{
    
    private nameRegExp = /^[a-z\s]{5,}$/i;
    private passwordRegExp = /(?=.*[A-Z])(?=.*\d)(?=.*[#@&%!_])(?=^[\w#@%&!]{5,16}$)/gm;
    ...
    private validatePassword = (password:string)=>{
        ...
        return 'A senha deve contar de 5 a 16 caracteres, onde pelo menos 1 deve ser maiuscula, 1 deve ser numero, 1 deve ser \"!@#&%\"';
    }
