    ...
    return(
        <form className="-mt-4" action="">
            ...
            <section className="w-full">
                ...
                <div className="flex items-center justify-start gap-9 w-full mb-2">
                    <div className="flex flex-col items-start justify-center w-5/12">
                        <input onChange={(e)=>{setAgencyDestinatary(e.target.value);isSubmitAllow()}} className="placeholder:font-base placeholder:font-medium placeholder:text-input-placeholder text-input-text font-base font-regular p-2 pl-3 rounded-md bg-input-base border border-input-border w-full" type="number" name="to-agency-input" id="to-agency-input" placeholder="1510-5"/>
                        <label className="text-xs mt-1 text-input-inactive font-regular font-xs" htmlFor="to-agency-input">Agência</label>
                    </div>
                    <div className="flex flex-col items-start justify-center w-5/12">
                        <input onChange={(e)=>{setAccountDestinatary(e.target.value);isSubmitAllow()}} className="placeholder:font-base placeholder:font-medium placeholder:text-input-placeholder text-input-text font-base font-regular p-2 pl-3 rounded-md bg-input-base border border-input-border w-full" type="number" name="to-account-input" id="to-account-input" placeholder="95785-3" />
            ...
            <input id="transfer-submit" disabled onClick={
                (e)=>{
                    ...
                    ApiRequest.typeTransaction = Transactions.Transfer;
                    ApiRequest.setTransferBody(name,agency,agencyDestinatary,account,accountDestinatary,password,value);
                }
            } className="disabled:opacity-50 hover:bg-btn-primary-hover transition-all duration-200 bg-btn-primary-base w-full text-sm font-medium text-white p-3 rounded mt-4" type="submit" value="Transferir" />
