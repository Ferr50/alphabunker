...
export function LoginComponent() {
    ...
    return (
        <section className="flex flex-col justify-center items-center">
            ...
            <div><input type="text" onChange={(e) => setCpf(e.target.value)} placeholder="Digite seu CPF" className="text-paragraph-dark text-center mb-3 w-240 p-1 border-2 border-gray-300 placeholder-input-placeholder border-input-b rounded-md dark:text-black" /></div>
            <p ref={cpfVerify} className="hidden text-red-600/100 absolute pb-4 text-sm">CPF Inválido</p>
            <div><input type="password" onChange={(e) => setPassword(e.target.value)} placeholder="Digite sua senha" className="text-paragraph-dark text-center mb-5 w-240 p-1 border-2 border-gray-300 placeholder-input-placeholder rounded-md dark:text-black" /></div>
