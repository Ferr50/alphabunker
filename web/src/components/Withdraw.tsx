            ...
            <section className="w-full">
                ...
                <div className="flex items-center justify-start gap-9 w-full mb-2">
                    <div className="flex flex-col items-start justify-center w-5/12">
                        <input className="placeholder:font-base placeholder:font-medium placeholder:text-input-inactive text-input-inactive font-base font-regular p-2 pl-3 rounded-md bg-input-readonly w-full" type="text" name="agency" id="agency-input" placeholder="1510-5" disabled/>
                        <label className="text-xs mt-1 text-input-inactive font-regular font-xs" htmlFor="agency-input">Agência</label>
                    </div>
                    <div className="flex flex-col items-start justify-center w-5/12">
                        <input className="placeholder:font-base placeholder:font-medium placeholder:text-input-inactive text-input-inactive font-base font-regular p-2 pl-3 rounded-md bg-input-readonly w-full" type="text" name="account" id="account-input" placeholder="95785-3" disabled/>
