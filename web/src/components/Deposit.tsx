...
export function Deposit(){
    ...
    return (
        <form className="-mt-4" action="">
            ...
            <input onClick={(e)=>{e.preventDefault();c!.setFinishModal(<ModalFinishTransaction />)}} className="bg-btn-primary-base w-full text-sm font-medium text-white p-3 rounded mt-4" type="submit" value="Depositar" />
        </form>
    );
}